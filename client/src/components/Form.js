...
const Form = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center mb-10 mt-28 ml-2 xl:mx-8  rounded bg-transparent " style={{ backgroundImage: "url('https://i.redd.it/islamia-college-peshawar-pakistan-v0-zyy8lfo8zcx91.jpg?width=1080&format=pjpg&auto=webp&s=e20bb64198f994ee95777c183716ecca191af150')",opacity:'90%' }}>
      ...
      <form noValidate className="space-y-12" onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <Link to="/forgot-password" className="text-xs lg:mr-64 text-white hover:underline">Forgot password?</Link>
          </div>
        </div>
        <div className="space-y-2">
          <div>
            <button type="button" className="w-full px-8 py-3 font-semibold mb-2 rounded-md bg-white text-black hover:bg-yellow-500 hover:text-black hover:scale-110">Log in</button>
          </div>
