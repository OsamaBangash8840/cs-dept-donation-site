    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-10  ">
          ...
          <Link  smooth to="/#contact" className="bg-yellow-500 px-6 py-4 rounded-full text-[17px] font-semibold font-ubuntu hover:bg-white hover:text-black">
            Get Started Now
          </Link>
        </div>
        <div className="flex flex-col justify-center items-start gap-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col justify-center items-start gap-6">
            ...
            <div className="flex flex-col justify-center items-start gap-6 w-full">
              ...
              />
              <button type="submit" className="bg-yellow-500 px-6 py-4 rounded-xl text-[17px] font-semibold font-ubuntu hover:bg-white hover:text-black">
                Subscribe Now
              </button>
            </div>
          </div>
